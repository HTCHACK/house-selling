                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"><a href="{{ route('etajs.create') }}" class="btn btn-info">Add
                                    ...
                                    <tbody>
                                        @foreach ($etajs as $key => $etaj)
                                            <tr>
                                                ...
                                                <td>{{ ++$key }}</td>
                                                <td>{{ $etaj->number }}</td>
                                                <td>{{ $etaj->blocks->number }}</td>
                                                <td>{{ $etaj->block_id }}</td>
                                                <td class="text-right">
                                                    <a href="{{ route('etajs.edit', $etaj->id) }}"
                                                        class="btn btn-outline-info btn-rounded"><i
                                                            class="fas fa-pen"></i></a>
                                                </td>
                                                <td><form action="{{ route('etajs.destroy', $etaj->id) }}"
